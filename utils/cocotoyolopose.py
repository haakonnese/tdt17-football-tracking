...
numOfKpts = 7 #replace this with the number of keypoints inside the dataset
...
parser.add_argument(
    "--yolo_save_root_dir",
    default="/cluster/work/haaknes/tdt17/yolov8/data/keypoint/",
    type=str,
...
if __name__ == "__main__":
    ...
    Path(YOLO_ANNO_TXT_SAVE_PATH).mkdir(parents=True, exist_ok=True)
